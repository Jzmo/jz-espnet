...
from espnet.nets.pytorch_backend.multiconformer.convolution import ConvolutionModule
from espnet.nets.pytorch_backend.multiconformer.encoder_layer import EncoderLayer
from espnet.nets.pytorch_backend.multiconformer.subsampling import Conv2dSubsampling
...
class Encoder(torch.nn.Module):
    ...
    def __init__(
        ...
        conv2 = ConvolutionModule
        conv2_layer_args = (attention_dim, 15)
        ...
        self.encoders = repeat(
            ...
            lambda lnum: EncoderLayer(
                ...
                conv2(*conv2_layer_args) if use_cnn_module else None,
                dropout_rate,
                normalize_before,
                concat_after,
            ),
