...
from espnet.nets.pytorch_backend.pformer.encoder import Encoder
...
class E2E(E2EConformer):
    ...
    def add_arguments(parser):
        ...
        E2E.add_pformer_arguments(parser)
        return parser

    @staticmethod
    def add_pformer_arguments(parser):
        """Add arguments for former model."""
        group = parser.add_argument_group("pformer model specific setting")
        group.add_argument(
