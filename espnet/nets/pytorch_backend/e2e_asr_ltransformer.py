...
from espnet.nets.pytorch_backend.ltransformer.encoder import Encoder
from espnet.nets.pytorch_backend.e2e_asr_transformer import E2E as E2ETransformer
from espnet.nets.pytorch_backend.e2e_asr_conformer import E2E as E2EConformer
from espnet.nets.pytorch_backend.ltransformer.argument import (
    add_arguments_ltransformer_common,  # noqa: H301
)
...
class E2E(E2ETransformer):
    ...
    def add_arguments(parser):
        ...
        E2EConformer.add_conformer_arguments(parser)
        E2E.add_ltransformer_arguments(parser)
        return parser

    @staticmethod
    def add_ltransformer_arguments(parser):
        """Add arguments for conformer model."""
        group = parser.add_argument_group("conformer model specific setting")
        group = add_arguments_ltransformer_common(group)
        return parser
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.encoder = Encoder(
            ...
            localized_transformer_window_size=args.localized_transformer_encoder_window_size,
        )
