...
from espnet.nets.pytorch_backend.convbert.encoder import Encoder
...
class E2E(E2ETransformer):
    ...
    def add_arguments(parser):
        ...
        E2E.add_convbert_arguments(parser)
        return parser

    @staticmethod
    def add_convbert_arguments(parser):
        group = parser.add_argument_group(
            "convbert model specific setting")
    ...
    def __init__(self, idim, odim, args, ignore_id=-1):
        ...
        self.encoder = Encoder(
            ...
            ac_attn_head_ratio=args.ac_attn_head_ratio,
            ac_cnn_module_kernel=args.ac_cnn_module_kernel,
        )
